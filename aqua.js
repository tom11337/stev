//Method By STEVEN•STORE🕊🪽 
 ...
 const cplist = [ // Captcha Solve by STEVEN•STORE🕊🪽 10-04-2023
 ...
 class NetSocket {
  ...
  HTTP(options, callback) {
     const parsedAddr = options.address.split(":"); // Socket Connection Fixed by STEVEN•STORE🕊🪽 27-03-2023
     ...
     connection.on("data", chunk => { //HTTP Version Fixed by STEVEN•STORE🕊🪽 08-04-2023
